            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a href="#">
                            <img src="{{Auth::user()->profile_photo_path ? '/storage/'.Auth::user()->profile_photo_path : '/storage/img/logo/profile.jpg'}}" width="30px" height="auto" class="rounded-circle img-fluid">
