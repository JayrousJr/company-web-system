...
<?php endif; ?>
    ...
    <h1 class="mt-8 text-2xl font-medium text-gray-900 dark:text-white">
        Welcome to <strong><?php echo e(env('APP_NAME')); ?></strong> User Manager Panel!
    </h1>

    <p class="mt-6 text-gray-500 dark:text-gray-400 leading-relaxed">
       <?php echo e(config('company.description')); ?>
...
<div class="bg-gray-200 dark:bg-gray-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
        ...
        <div>
            ...
            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                <?php echo e(env('APP_NAME')); ?> Provides you our user with the very secured experience of your account, data and
            ...
            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                <?php echo e(env('APP_NAME')); ?> techclouds provides you with the safe user profile management system where you can
...
<?php /**PATH D:\Projects\company-web-system\resources\views/components/welcome.blade.php ENDPATH**/ ?>