...
<footer id="footer">
    ...
    <div class="container footer-bottom clearfix">
        <div class="copyright">
            &copy; Copyright <?php echo ' ' . date('Y'); ?> <strong><span><?php echo e(config("company.name")); ?></span></strong>. All Rights Reserved
        </div>
        <div class="credits">
            Designed by <a href="<?php echo e(config('company.link')); ?>"><?php echo e(config("company.name")); ?></a>
        </div>
    </div>
</footer><!-- End Footer -->
...
</html><?php /**PATH D:\Projects\company-web-system\resources\views/site/partials/footer.blade.php ENDPATH**/ ?>