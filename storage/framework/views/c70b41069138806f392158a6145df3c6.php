...
<body>
    ...
    <header id="header" class="fixed-top header-inner-pages">
        <div class="container d-flex align-items-center">
            ...
            <a href="<?php echo e(route('home')); ?>" class="logo me-auto"><img src="/storage/img/logo/logo.png" alt=""
                    class="img-fluid"></a>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a href="#">
                            <img src="<?php echo e(Auth::user()->profile_photo_path ? '/storage/'.Auth::user()->profile_photo_path : '/storage/img/logo/profile.jpg'); ?>"
    ...
    </header><!-- End Header --><?php /**PATH F:\Projects\company-web-system\resources\views//site/partials/header.blade.php ENDPATH**/ ?>