...
<main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
            ...
            <h2>About <?php echo e(env('APP_NAME')); ?></h2>
    ...
    <section class="inner-page">
        <div class="container">
            <h2>
                What is <?php echo e(env("APP_NAME")); ?>

            </h2>
            <div class="row content">
                <div class="col-lg-6">
                    <p>
                        Welcome to <?php echo e(env('APP_NAME')); ?>, your one-stop-shop for all your Web design, Graphic Design,
            ...
            <div class="row content">
                <div class="col-12 pt-lg-2">
                    <h2>
                        Services Offered at <?php echo e(env("APP_NAME")); ?>
...
<!-- ======= Footer ======= -->
<?php echo $__env->make('site/partials/footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\company-web-system\resources\views//site/about.blade.php ENDPATH**/ ?>