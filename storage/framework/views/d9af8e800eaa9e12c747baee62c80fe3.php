...
<main id="main">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row content">
                ...
                <div class="col-lg-6 pt-4 pt-lg-0">
                    ...
                    <a href="<?php echo e(route('about')); ?>" class="btn-learn-more">More About Us</a>
                </div>
            </div>
        ...
        <div class="container-fluid" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
                    ...
                    <div class="content">
                        <h3>Why Should You Choose <strong><?php echo e(config('company.name')); ?></strong> To Get Your Job Done</h3>
                    </div>
                        ...
                        <ul>
                            <li> 
                                ...
                                <div id="accordion-list-1" class="collapse show" data-bs-parent=".accordion-list">
                                    <p>
                                       At <strong><?php echo e(config('company.name')); ?></strong>, we boast a diverse team of highly skilled professionals proficient in various aspects of technology, from website design and development to cybersecurity. With our comprehensive expertise, we offer holistic solutions to meet all your technological needs under one roof, saving you time and resources.
                                    </p>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div id="accordion-list-3" class="collapse" data-bs-parent=".accordion-list">
                                    <p>
                                        Your satisfaction is our top priority at <strong><?php echo e(config('company.name')); ?></strong>. We prioritize clear communication, attentive listening, and responsive support throughout every stage of your project. Our dedicated team is committed to understanding your needs and delivering results that not only meet but exceed your expectations. With <strong><?php echo e(config('company.name')); ?></strong>, you can expect a seamless and enjoyable experience from start to finish.
                                    </p>
                                </div>
                            </li>
    ...
    <section id="services" class="services section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                <h2>Services</h2>
                <p>Pick among of our best service here at <strong><?php echo e(config('company.name')); ?></strong>.</p>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6 col-sm-12 d-flex align-items-stretch mb-4" data-aos="zoom-in"
                    ...
                    <div class="icon-box">
                        ...
                        <h4><a href="<?php echo e(route('service',$data->id)); ?>"><?php echo e($data->service_name); ?></a></h4>
                        <p><?php echo \Illuminate\Support\Str::limit(strip_tags($data->service_description), 100); ?></p>
                    </div>
                </div>
    ...
    <section id="portfolio" class="portfolio ">
        <div class="container" data-aos="fade-up">
            ...
            <ul id="portfolio-flters" class="d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
                ...
                <?php $__currentLoopData = $servicegen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li data-filter=".filter-<?php echo e($data->service_class); ?>"><?php echo e($data->service_class); ?></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
            ...
            <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-<?php echo e($data->projectClass); ?>">
                    <?php if(count($data->projectImage) > 0): ?>
                    <div class="portfolio-img">
                        <img src="/storage/<?php echo e($data->projectImage[0]); ?>" class="img-fluid" alt="">
                    </div>
                    <?php endif; ?>
                    <div class="portfolio-info">
                        <h4><?php echo e($data->clientName); ?></h4>
                        <p><?php echo e($data->projectClass); ?></p>
                        <?php if(count($data->projectImage) > 0): ?>
                        <a href="/storage/<?php echo e($data->projectImage[0]); ?>" data-gallery="portfolioGallery"
                            class="portfolio-lightbox preview-link" title="<?php echo e($data->clientName); ?>">
                            <i class="bx bx-plus"></i>
                        </a>
                        <?php endif; ?>

                        <a href="<?php echo e(route('project',$data->id)); ?>" class="details-link" title="More Details"><i
    ...
    <section id="team" class="team  section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                <h2>Team</h2>
                <p>Our team of Programmers and developers <strong><?php echo e(config('company.name')); ?></strong> Team.</p>
            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="col-md-6 offset-md-3 mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="100">
                                <div class="member d-flex align-items-start">
                                    <div class="pic">
                                        <img src="/storage/<?php echo e($data->profile_photo_path); ?>" class="img-fluid" alt="">
                                    </div>
                                    <div class="member-info">
                                        <h4><?php echo e($data->name); ?></h4>
                                        <span><?php echo e($data->profession); ?></span>
                                        <p>Approved Staff Member at <strong><strong><?php echo e(config('company.name')); ?></strong></strong> Company</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <ul>
                    ...
                    <li data-aos="fade-up" data-aos-delay="200">
                        ...
                        <a data-bs-toggle="collapse"
                            data-bs-target="#faq-list-2" class="collapsed">Do i need to have a <strong><?php echo e(config('company.name')); ?></strong> Account?
                            <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i>
                        </a>
                        <div id="faq-list-2" class="collapse" data-bs-parent=".faq-list">
                            <p>
                                Having an account at <strong><?php echo e(config('company.name')); ?></strong> is not so necessary, but it is important if you want to ask for services, Send us message and if you want to make a move towards <strong><?php echo e(config('company.name')); ?></strong>. Having an account will help you to manage your informations about <strong><?php echo e(config('company.name')); ?></strong> as well as we provide a useful dashboard for all our users who have active accounts. So it is worthy having an account.
                            </p>
                        </div>
                    </li>
                    ...
                    <li data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div id="faq-list-3" class="collapse" data-bs-parent=".faq-list">
                            ...
                            <p>
                                You can now log in to your account and be able to access all the materials offered by <strong><?php echo e(config('company.name')); ?></strong>. Do not forget to access your dashboard because it has a variety of more useful thing for you. You can see all the messages you have communicated to us, you can see all the services you have ever asked and more over you can be able to change your informations like name, profile picture and password. You can also enforce the 2FA technique to secure your account.
                            </p>
                        </div>
                    </li>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 d-flex align-items-stretch">
                    <div class="info">
                        <div class="address">
                            ...
                            <h4>Location:</h4>
                            <p><?php echo e(config("company.address.street")); ?>, <?php echo e(config("company.address.city")); ?>, <?php echo e(config("company.address.country")); ?></p>
                        </div>

                        <div class="email">
                            <i class="bi bi-envelope"></i>
                            <h4>Email:</h4>
                            <p><a href="mailto:<?php echo e(config('company.email')); ?>"><?php echo e(config("company.email")); ?></a></p>
                        </div>
                        ...
                        <div class="phone">
                            ...
                            <h4>Call:</h4>
                            <p>
                                <a href="tel:<?php echo e(config('company.email')); ?>"><?php echo e(config("company.phone")); ?></a><br>
                          <a href="tel:<?php echo e(config('company.email')); ?>"><?php echo e(config("company.phone1")); ?></a>
                        </p>
                        </div>
                ...
                <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                    <form action="<?php echo e(route('send')); ?>" method="post" class="php-email-form">
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control w-100 <?php $__errorArgs = ['message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body bg-light">
                    <p class="lead">Sorry, <strong><?php echo e(config('company.name')); ?></strong> requires you to have an active account so that you can send a
                        Message
                    </p>
                </div>
                <div class="modal-footer">
                    <a class="btn btn-primary float-left" href="<?php echo e(route('login')); ?>">Log in</a>
                    <a class="btn btn-primary float-right" href="<?php echo e(url('/register')); ?>">Register</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('/site/partials/footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Projects\company-web-system\resources\views//site/index.blade.php ENDPATH**/ ?>