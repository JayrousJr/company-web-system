...
<body>
    ...
    <header id="header" class="fixed-top header-inner-pages">
        <div class="container d-flex align-items-center">
            ...
            <a href="<?php echo e(route('home')); ?>" class="logo me-auto"><img src="/storage/img/logo/logo.webp" alt="" class="img-fluid"></a>
    ...
    </header><!-- End Header --><?php /**PATH E:\Projects\company-web-system\resources\views//site/partials/header.blade.php ENDPATH**/ ?>